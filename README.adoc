...
TeslaConsulting **Qualysbeat** is an open source tool which leverages the Qualys API to collect the platform logs and ship them with all the flexibility and capabilities provided by the beats platform toward ElasticSearch instance
