...
`${GOPATH}/src/github.com/fs015/qualysbeat`
...
```
git remote set-url origin https://github.com/fs015/qualysbeat
...
in the same directory with the name qualysbeat.
...
```
./qualysbeat -c qualysbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/fs015/qualysbeat
git clone https://github.com/fs015/qualysbeat ${GOPATH}/src/github.com/fs015/qualysbeat
```
